class Candidate < ActiveRecord::Base
	...
	#validates :name, format: {with: /\A[a-zA-Z-_. ]+$\z/, message: "only allows letters"}, :allow_blank => true

	validates :age, numericality: { greater_than_or_equal_to: 18, less_than_or_equal_to: 100}, :allow_blank => true
	...
	#validates :spouse_name, :education, :occupation, format: {with: /\A[a-zA-Z]+\z/, message: "only allows letters"}, :allow_blank => true
