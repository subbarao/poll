...
=begin
  ...
  test "should create response" do
    assert_difference('Response.count') do
      post :create, response: { seat_id: @response.seat_id, user_id: @response.user_id }
    end
  ...
  test "should update response" do
    patch :update, id: @response, response: { seat_id: @response.seat_id, user_id: @response.user_id }
    assert_redirected_to response_path(assigns(:response))
  end
